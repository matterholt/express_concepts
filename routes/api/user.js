...
router.put("/:id/update", (req, res) => {
  ...
  db.query(
    "UPDATE users SET email = $1, user_pass = $2, user_role = $3 WHERE user_ID = $4",
    [userEmail, userPassword, userRole, id],
    (error, results) => {
      if (error) {
        throw error;
      }
...
router.post("/newuser", (req, res) => {
  ...
  db.query(
    "INSERT INTO users (email, user_pass, user_role) VALUES($1, $2, $3)",
