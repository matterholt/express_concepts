...
VALUES ('pOne@example.com',
        ...
        'D1'), ('pTwo@example.com',
                ...
                'player',
                'two',
                'D1'), ('pThree@example.com',
                        'abc',
                        'player3',
                        'player',
                        'there',
                        'V2'), ('pFour@example.com',
                                'abc',
                                'player4',
                                'player',
                                'four',
...
CREATE TABLE feaRequest
    (request_ID SERIAL PRIMARY KEY,
                               version_name VARCHAR(10) NOT NULL,
                                                        base_on VARCHAR(10),
                                                                weight_kg REAL, purpose TEXT, changelog TEXT, submitDateTime TIMESTAMP DEFAULT CURRENT_TIMESTAMP(2),
                                                                                                                                               perform_analysis TEXT, project_code SERIAL REFERENCES projects(project_ID) ON DELETE CASCADE,
                                                                                                                                                                                                                                    requester SERIAL REFERENCES users(user_ID) ON DELETE CASCADE);


INSERT INTO feaRequest (version_name, base_on, weight_kg, purpose, changelog, perform_analysis, project_code, requester)
VALUES ('v01r01',
        'v01r00',
        34.6,
        'to make better',
        'bead on front , hole on side',
        'stiffness',
        1,
        2), ('v02r01',
             'v01r56',
...
CREATE TABLE results
    (analysis_id SERIAL PRIMARY KEY,
                                analysis_perform TEXT, judgment VARCHAR(50),
                                                                published BOOLEAN DEFAULT FALSE,
                                                                                          publish_dateTime TIMESTAMP DEFAULT CURRENT_TIMESTAMP(2),
                                                                                                                             checked BOOLEAN DEFAULT FALSE,
                                                                                                                                                     v2_pic text, req_status text, request_ID SERIAL REFERENCES feaRequest(request_ID) ON DELETE CASCADE);
